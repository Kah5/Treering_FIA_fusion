plot2AGB_nocc <- function(combined, out, mort.scheme, allom.stats, unit.conv = 0.02, plot = plot, yrvec = 2001:2098, scenario = "rcp26", p = p, p.inc = p.inc) {
  ...
  cat("saving outputs")
  cowplot::save_plot(paste0("/home/rstudio/data/output/biomass_plots_nocc/Plot_biomass_inc_",mort.scheme,".", plot, ".",scenario,".png"), both.plot, base_height = 10, base_width = 12, units = "in")
  ...
  save(out, AGB, NPP, mNPP, sNPP, mAGB, sAGB, yrvec, plot, 
       ...
       file = file.path("/home/rstudio/",paste0("data/output/biomass_data_nocc/plot2AGB_",mort.scheme,".",plot,".",scenario,".Rdata")))

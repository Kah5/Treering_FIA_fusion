...
# -------------------------------------------------------------------------------
# RCP2.6
normort.AGB <- lapply(unique(unique.plts$PLT_CN)[1:417], FUN = function(x) {get_biomass_ests(plot = x, mort.scheme = "nomort", scenario = "rcp26", SDI.ratio.DD = 0.7, cc.scenario = "singleCC")})
DIonly.AGB <- lapply(unique(unique.plts$PLT_CN)[1:417], FUN = function(x) {get_biomass_ests(plot = x, mort.scheme = "DIonly", scenario = "rcp26", SDI.ratio.DD = 0.7, cc.scenario = "singleCC")})
DDonly.AGB <- lapply(unique(unique.plts$PLT_CN)[1:417], FUN = function(x) {get_biomass_ests(plot = x, mort.scheme = "DDonly", scenario = "rcp26", SDI.ratio.DD = 0.7, cc.scenario = "singleCC")})
DIDD.AGB <- lapply(unique(unique.plts$PLT_CN)[1:417], FUN = function(x) {get_biomass_ests(plot = x, mort.scheme = "DIDD", scenario = "rcp26", SDI.ratio.DD = 0.7, cc.scenario = "singleCC")})
...
saveRDS(all10plots, "all.AGB.fiaAnnual_singleCC_12.30.22tempfile.RDS")

# -------------------------------------------------------------------------------
# read in forecasts for all scenarios and mortality conditions (double cc)
# -------------------------------------------------------------------------------
# RCP2.6
normort.AGB <- lapply(unique(unique.plts$PLT_CN)[1:417], FUN = function(x) {get_biomass_ests(plot = x, mort.scheme = "nomort", scenario = "rcp26", SDI.ratio.DD = 0.7, cc.scenario = "doubleCC")})
DIonly.AGB <- lapply(unique(unique.plts$PLT_CN)[1:417], FUN = function(x) {get_biomass_ests(plot = x, mort.scheme = "DIonly", scenario = "rcp26", SDI.ratio.DD = 0.7, cc.scenario = "doubleCC")})
DDonly.AGB <- lapply(unique(unique.plts$PLT_CN)[1:417], FUN = function(x) {get_biomass_ests(plot = x, mort.scheme = "DDonly", scenario = "rcp26", SDI.ratio.DD = 0.7, cc.scenario = "doubleCC")})
DIDD.AGB <- lapply(unique(unique.plts$PLT_CN)[1:417], FUN = function(x) {get_biomass_ests(plot = x, mort.scheme = "DIDD", scenario = "rcp26", SDI.ratio.DD = 0.7, cc.scenario = "doubleCC")})
...
saveRDS(all10plots, "all.AGB.fiaAnnual_doubleCC_12.30.22tempfile.RDS")


#all10plot <- readRDS( "all.AGB.fiaAnnual_singleCC_12.30.22tempfile.RDS")
...
png(height = 7, width = 10, units = "in", res = 150, "outputs/exampleallrunplotsFIAannual.total.biomass.doubleCC.png")
...
# RCP 2.6
btst.AGB.DIDD.26 <- lapply(unique(unique.plts$PLT_CN)[1:417], FUN = function(x){get_tree_levelC_ests_FVS(plot = x, mort.scheme = "DIDD", scenario = "rcp26",SDI.ratio.DD = 0.7, cc.scenario = "singleCC")})
btst.AGB.DIDD.26.df <- do.call(rbind, btst.AGB.DIDD.26)
btst.AGB.DIDD.26.df


btst.AGB.nomort.26 <- lapply(unique(unique.plts$PLT_CN)[1:417], FUN = function(x){get_tree_levelC_ests_FVS(plot = x, mort.scheme = "nomort", scenario = "rcp26",SDI.ratio.DD = 0.7, cc.scenario = "singleCC")})
btst.AGB.nomort.26.df <- do.call(rbind, btst.AGB.nomort.26)

btst.AGB.DDonly.26 <- lapply(unique(unique.plts$PLT_CN)[1:417], FUN = function(x){get_tree_levelC_ests_FVS(plot = x, mort.scheme = "DDonly", scenario = "rcp26",SDI.ratio.DD = 0.7, cc.scenario = "singleCC")})
btst.AGB.DDonly.26.df <- do.call(rbind, btst.AGB.DDonly.26)


btst.AGB.DIonly.26 <- lapply(unique(unique.plts$PLT_CN)[1:417], FUN = function(x){get_tree_levelC_ests_FVS(plot = x, mort.scheme = "DIonly", scenario = "rcp26",SDI.ratio.DD = 0.7, cc.scenario = "singleCC")})
...
saveRDS(allplots.treeC, "outputs/allplots.FIAannual.treeC12.30.22.RDS")
...
# read in and get the tree level estimates
# RCP 2.6
btst.AGB.DIDD.26 <- lapply(unique(unique.plts$PLT_CN)[1:417], FUN = function(x){get_tree_levelC_ests_FVS(plot = x, mort.scheme = "DIDD", scenario = "rcp26",SDI.ratio.DD = 0.7, cc.scenario = "doubleCC")})
btst.AGB.DIDD.26.df <- do.call(rbind, btst.AGB.DIDD.26)
btst.AGB.DIDD.26.df


btst.AGB.nomort.26 <- lapply(unique(unique.plts$PLT_CN)[1:417], FUN = function(x){get_tree_levelC_ests_FVS(plot = x, mort.scheme = "nomort", scenario = "rcp26",SDI.ratio.DD = 0.7, cc.scenario = "doubleCC")})
btst.AGB.nomort.26.df <- do.call(rbind, btst.AGB.nomort.26)

btst.AGB.DDonly.26 <- lapply(unique(unique.plts$PLT_CN)[1:417], FUN = function(x){get_tree_levelC_ests_FVS(plot = x, mort.scheme = "DDonly", scenario = "rcp26",SDI.ratio.DD = 0.7, cc.scenario = "doubleCC")})
btst.AGB.DDonly.26.df <- do.call(rbind, btst.AGB.DDonly.26)


btst.AGB.DIonly.26 <- lapply(unique(unique.plts$PLT_CN)[1:417], FUN = function(x){get_tree_levelC_ests_FVS(plot = x, mort.scheme = "DIonly", scenario = "rcp26",SDI.ratio.DD = 0.7, cc.scenario = "doubleCC")})
btst.AGB.DIonly.26.df <- do.call(rbind, btst.AGB.DIonly.26)
...
#btst.AGB.nomort.85.df, btst.AGB.DIonly.85.df, btst.AGB.DDonly.85.df, btst.AGB.DIDD.85.df) #, 
#btst.AGB.nomort.nocc.df, btst.AGB.DIonly.nocc.df, btst.AGB.DDonly.nocc.df, btst.AGB.DIDD.nocc.df)
saveRDS(allplots.treeC, "outputs/allplots.FIAannual.treeC12.30.22_doubleCC.RDS")
...
png(height = 10, width = 10, units = "in", res = 150, "outputs/big_tree_vs_small_tree_all_run_plotsFIAannual_doubleCC.png")
...
png(height = 10, width = 10, units = "in", res = 150, "outputs/big_tree_vs_small_tree_one_plot_FIAannual_doubleCC.png")
...
png(height = 10, width = 10, units = "in", res = 150, "outputs/big_tree_vs_small_tree_two_plotFIAannual_doubleCC.png")
...
png(height = 10, width = 10, units = "in", res = 150, "outputs/big_tree_vs_small_tree_three_plotFIAannual_doubleCC.png")
...
png(height = 10, width = 10, units = "in", res = 150, "outputs/big_tree_vs_small_tree_dominated_FIAannual_doubleCC.png")
...
png(height = 10, width = 10, units = "in", res = 150, "outputs/big_tree_vs_small_tree_dominated_prop_biomass_FIAannual_doubleCC.png")
...
# -------------------------------------------------------------------------------
get_tree_diam_live_dead_ests <- function(plot, mort.scheme, scenario, nocc = FALSE, cc.scenario){
...
# read in and get the tree level estimates
# RCP 2.6
btst.DIAMS.DIDD.26 <- lapply(unique(unique.plts$PLT_CN)[1:417], FUN = function(x){get_tree_diam_live_dead_ests(plot = x, mort.scheme = "DIDD", scenario = "rcp26", cc.scenario = "singleCC")})
btst.DIAMS.DIDD.26.df <- do.call(rbind, btst.DIAMS.DIDD.26)
btst.DIAMS.DIDD.26.df

btst.DIAMS.nomort.26<- lapply(unique(unique.plts$PLT_CN)[1:417], FUN = function(x){get_tree_diam_live_dead_ests(plot = x, mort.scheme = "nomort", scenario = "rcp26", cc.scenario = "singleCC")})
 btst.DIAMS.nomort.26.df <- do.call(rbind, btst.DIAMS.nomort.26)
# 
 btst.DIAMS.DDonly.26<- lapply(unique(unique.plts$PLT_CN)[1:417], FUN = function(x){get_tree_diam_live_dead_ests(plot = x, mort.scheme = "DDonly", scenario = "rcp26", cc.scenario = "singleCC")})
 btst.DIAMS.DDonly.26.df <- do.call(rbind, btst.DIAMS.DDonly.26)
# 
 btst.DIAMS.DIonly.26<- lapply(unique(unique.plts$PLT_CN)[1:417], FUN = function(x){get_tree_diam_live_dead_ests(plot = x, mort.scheme = "DIonly", scenario = "rcp26", cc.scenario = "singleCC")})
...
saveRDS(rcp26.DIAMS, "annaulFIA.btst.DIAMS.RDS")
...
saveRDS(allplots.treeDIAM, "outputs/allplots.treeDiam.forecast.AnnualFIA.RDS")
...
# read in and get the tree level estimates
# RCP 2.6
btst.DIAMS.DIDD.26 <- lapply(unique(unique.plts$PLT_CN)[1:417], FUN = function(x){get_tree_diam_live_dead_ests(plot = x, mort.scheme = "DIDD", scenario = "rcp26", cc.scenario = "doubleCC")})
btst.DIAMS.DIDD.26.df <- do.call(rbind, btst.DIAMS.DIDD.26)
btst.DIAMS.DIDD.26.df

btst.DIAMS.nomort.26<- lapply(unique(unique.plts$PLT_CN)[1:417], FUN = function(x){get_tree_diam_live_dead_ests(plot = x, mort.scheme = "nomort", scenario = "rcp26", cc.scenario = "doubleCC")})
btst.DIAMS.nomort.26.df <- do.call(rbind, btst.DIAMS.nomort.26)
# 
btst.DIAMS.DDonly.26<- lapply(unique(unique.plts$PLT_CN)[1:417], FUN = function(x){get_tree_diam_live_dead_ests(plot = x, mort.scheme = "DDonly", scenario = "rcp26", cc.scenario = "doubleCC")})
btst.DIAMS.DDonly.26.df <- do.call(rbind, btst.DIAMS.DDonly.26)
# 
btst.DIAMS.DIonly.26<- lapply(unique(unique.plts$PLT_CN)[1:417], FUN = function(x){get_tree_diam_live_dead_ests(plot = x, mort.scheme = "DIonly", scenario = "rcp26", cc.scenario = "doubleCC")})
btst.DIAMS.DIonly.26.df <- do.call(rbind, btst.DIAMS.DIonly.26)
# 
...
saveRDS(allplots.treeDIAM, "outputs/allplots.treeDiam.forecast.AnnualFIA_doubleCC.RDS")
...
saveRDS(all.trees.2001.2010, "all.trees.2001.2010.FIAannual_doubleCC.rds")
all.trees.2001.2010 <- readRDS("all.trees.2001.2010.FIAannual_doubleCC.rds")

all.trees.2011.2020 <- allplots.treeDIAMsubset %>% group_by(df,plot,  mort.scheme, scenario, time) %>% filter(time %in% 11:20)%>%
  summarise(ntree = sum(TPA))%>%ungroup()  %>% 
  group_by(plot, mort.scheme, scenario, time) %>% spread(df, value = ntree)%>% group_by(plot, mort.scheme, scenario, time) %>% 
  mutate(prop.dead = ifelse(is.na(dead), 1, dead/(live + dead)))# gets # dead for each plot in each year
saveRDS(all.trees.2011.2020, "all.trees.2011.2020.FIAannual_doubleCC.rds")
...
png(height = 10, width = 10, units = "in", res = 150, "outputs/scatter_mort_rate_by_dia_sdi_lines_forecast_all_doubleCC.png")
...
png(height = 10, width = 10, units = "in", res = 150, "outputs/scatter_total_by_dia_sdi_lines_forecast_all_doubleCC.png")
...
png(height = 10, width = 10, units = "in", res = 150, "outputs/boxplot_totals_rate_by_dia_forecast_all_doubleCC.png")
...
png(height = 10, width = 10, units = "in", res = 150, "outputs/boxplot_mort_rate_by_dia_forecast_all_doubleCC.png")
...
png(height = 10, width = 10, units = "in", res = 150, "outputs/boxplot_mort_rate_by_sdi_forecast_all_doubleCC.png")
...
png(height = 10, width = 10, units = "in", res = 150, "outputs/boxplot_total_by_sdi_forecast_all_doubleCC.png")
...
png(height = 10, width = 10, units = "in", res = 150, "outputs/tile_prop_mort_by_dia_sdi_forecast_all_doubleCC.png")
...
png(height = 10, width = 10, units = "in", res = 150, "outputs/tile_total_by_dia_sdi_forecast_all_doubleCC.png")
...
# We cant compare to the number of dead for these same plots over this time period because there is not linkage of annual and periodic                                                                                                                                                                                      mort_rate_ecoregion_2020 =  prop_dead_ecoregion_2020/10)
#------------------------------------------------------------------------------------
# get torching and crowning indices from the diameter distributions
#------------------------------------------------------------------------------------
# get the aboveground woody biomass component:
all10plot.nocc <- readRDS("all.AGB.fiaAnnual_singleCC_12.30.22tempfile.RDS")
...
forecast.plt  <- readRDS("outputs/allplots.treeDiam.forecast.AnnualFIA.RDS")
...
a3 <- get_torch_crown_indices_FORECASTS(plt = unique(unique.plts$PLT_CN)[1], fuelmodel = "TU5" )
a3
...
for(i in 1:length(unique(unique.plts$PLT_CN)[1:417])){
TI.CI.list[[i]] <- get_torch_crown_indices_FORECASTS(plt = unique(unique.plts$PLT_CN)[i], fuelmodel = "TU5")
}

TI.CI.FORECASTS <- do.call(rbind, TI.CI.list)
#TI.CI.FORECASTS$TI_km_hr <- (TI.CI.FORECASTS$TI/1000)*60 # convert from m/min to km/hr

saveRDS(TI.CI.FORECASTS, "TI.CI.snapshots.FIAannual_TU5_5lagdead.rds")
...
for(i in 1:length(unique(unique.plts$PLT_CN)[1:417])){
  TI.CI.list[[i]] <- get_torch_crown_indices_FORECASTS(plt = unique(unique.plts$PLT_CN)[i], fuelmodel = "TL5")
}

TI.CI.FORECASTS <- do.call(rbind, TI.CI.list)
#TI.CI.FORECASTS$TI_km_hr <- (TI.CI.FORECASTS$TI/1000)*60 # convert from m/min to km/hr

saveRDS(TI.CI.FORECASTS, "TI.CI.snapshots.FIAannual_TL5_5lagdead.rds")

# run for singleCC and fuel model TL9
for(i in 1:length(unique(unique.plts$PLT_CN)[1:417])){
  TI.CI.list[[i]] <- get_torch_crown_indices_FORECASTS(plt = unique(unique.plts$PLT_CN)[i], fuelmodel = "TL9")
}

TI.CI.FORECASTS <- do.call(rbind, TI.CI.list)
#TI.CI.FORECASTS$TI_km_hr <- (TI.CI.FORECASTS$TI/1000)*60 # convert from m/min to km/hr

saveRDS(TI.CI.FORECASTS, "TI.CI.snapshots.FIAannual_TL9_5lagdead.rds")


#TI.CI.FORECASTS <- readRDS( "TI.CI.snapshots_with_estimated_dead_litter_fixed_ba_dynamicwoody.rds")

TL5.TI.CI <- readRDS("TI.CI.snapshots.FIAannual_TL5_5lagdead.rds")
TL9.TI.CI <- readRDS("TI.CI.snapshots.FIAannual_TL9_5lagdead.rds")
TU5.TI.CI <- readRDS("TI.CI.snapshots.FIAannual_TU5_5lagdead.rds")
...
png(height = 6, width = 8, units = "in", res = 250, "outputs/crown_fire_hazard_pct_pltsFIAannual_singleCC_5lagdead.png")
...
png(height = 6, width = 8, units = "in", res = 250, "outputs/crown_fire_hazard_hists_TI_AnnualByFuelModel_5lagdead.png")
...
png(height = 6, width = 8, units = "in", res = 250, "outputs/crown_fire_hazard_hists_CI_AnnualByFuelModel_5lagdead.png")
ggplot(TI.CI.FORECASTS, aes(x = CI_km_hr_trunc))+geom_histogram()+facet_grid(rows = vars(mort.scheme), cols = vars(fuelmodel))+
  theme(legend.position = "none")+geom_vline(aes(xintercept = c(high.crown.haz)))+geom_vline(aes(xintercept = c(low.crown.haz)))
dev.off()

png(height = 6, width = 8, units = "in", res = 250, "outputs/crown_fire_hazard_hists_flame_length_AnnualByFuelModel_5lagdead.png")
...
png(height = 6, width = 8, units = "in", res = 250, "outputs/torch_fire_hazard_pct_plts_AnnualByFuelModel_5lagdead.png")
...
#------------------------------------------------------------------------------------
# get the aboveground woody biomass component:
all10plot.nocc <- readRDS("all.AGB.fiaAnnual_doubleCC_12.30.22tempfile.RDS")
all.woody.agb.26 <- all10plot.nocc %>% group_by(plot, mort.scheme, rcp) %>% arrange(plot, mort.scheme, rcp, year) %>% 
  #group_by(plot, mort.scheme, rcp, year) %>% 
  #mutate(lag.value = lag(mAGB.dead)) #%>% 
  mutate(dead.lagged = dplyr::lag(mAGB.dead, n = 5,  order_by=year))%>% group_by(plot, mort.scheme, rcp, year)%>% #select(mAGB.stemwood, mAGB.stembark, mAGB.branchdead, mAGB.branchlive) %>%
...
rm(fiadb)
# get the diameter distributions of each plot
forecast.plt  <- readRDS("outputs/allplots.treeDiam.forecast.AnnualFIA_doubleCC.RDS")
#forecast.plt <- allplots.treeDIAM
rm(allplots.treeDIAM)
rm(SUBPLOT)
rm(TREE_remeas)
...
saveRDS(TI.CI.FORECASTS, "TI.CI.snapshots.FIAannual_TU5_5lagdead_doubleCC.rds")
...
saveRDS(TI.CI.FORECASTS, "TI.CI.snapshots.FIAannual_TL5_5lagdead_doubleCC.rds")
...
saveRDS(TI.CI.FORECASTS, "TI.CI.snapshots.FIAannual_TL9_5lagdead_doubleCC.rds")


#TI.CI.FORECASTS <- readRDS( "TI.CI.snapshots_with_estimated_dead_litter_fixed_ba_dynamicwoody.rds")

TL5.TI.CI <- readRDS("TI.CI.snapshots.FIAannual_TL5_5lagdead_doubleCC.rds")
TL9.TI.CI <- readRDS("TI.CI.snapshots.FIAannual_TL9_5lagdead_doubleCC.rds")
TU5.TI.CI <- readRDS("TI.CI.snapshots.FIAannual_TU5_5lagdead_doubleCC.rds")
...
png(height = 6, width = 8, units = "in", res = 250, "outputs/crown_fire_hazard_pct_pltsFIAannual_singleCC_5lagdead_doubleCC.png")
ggplot()+geom_bar(data = na.omit(crown_hazard.summary), aes(x = time, y = pct.plts, fill = crown_hazard), position="fill", stat="identity")+
  facet_grid(rows = vars(mort.scheme), cols = vars(fuelmodel))+scale_fill_manual(values = c("low fire hazard" = "#2c7bb6", "moderate fire hazard" = "#fdae61" , "high fire hazard" = "#d7191c"), name = "crown hazard")+
  theme_bw(base_size = 12) + ylab("% of plots in each hazard category")
dev.off()
...
png(height = 6, width = 8, units = "in", res = 250, "outputs/crown_fire_hazard_hists_TI_AnnualByFuelModel_5lagdead_doubleCC.png")
ggplot(TI.CI.FORECASTS, aes(x = TI_km_hr_trunc))+geom_histogram()+facet_grid(rows = vars(mort.scheme), cols = vars(fuelmodel))+
  theme(legend.position = "none")+geom_vline(aes(xintercept = c(high.crown.haz)))+geom_vline(aes(xintercept = c(low.crown.haz)))
dev.off()

png(height = 6, width = 8, units = "in", res = 250, "outputs/crown_fire_hazard_hists_CI_AnnualByFuelModel_5lagdead_doubleCC.png")
ggplot(TI.CI.FORECASTS, aes(x = CI_km_hr_trunc))+geom_histogram()+facet_grid(rows = vars(mort.scheme), cols = vars(fuelmodel))+
  theme(legend.position = "none")+geom_vline(aes(xintercept = c(high.crown.haz)))+geom_vline(aes(xintercept = c(low.crown.haz)))
dev.off()

png(height = 6, width = 8, units = "in", res = 250, "outputs/crown_fire_hazard_hists_flame_length_AnnualByFuelModel_5lagdead_doubleCC.png")
ggplot(TI.CI.FORECASTS, aes(x = flame_length_m))+geom_histogram()+facet_grid(rows = vars(mort.scheme), cols = vars(fuelmodel))+
  theme(legend.position = "none")#+xlim(0, 3)#+geom_vline(aes(xintercept = c(high.crown.haz)))+geom_vline(aes(xintercept = c(low.crown.haz)))
dev.off()


png(height = 6, width = 8, units = "in", res = 250, "outputs/torch_fire_hazard_pct_plts_AnnualByFuelModel_5lagdead_doubleCC.png")
ggplot()+geom_bar(data = na.omit(torch_hazard.summary), aes(x = time, y = pct.plts, fill = torch_hazard), position="fill", stat="identity")+
  facet_grid(rows = vars(mort.scheme), cols = vars(fuelmodel))+scale_fill_manual(values = c("low fire hazard" = "#2c7bb6", "moderate fire hazard" = "#fdae61" , "high fire hazard" = "#d7191c"), name = "torch hazard")+
  theme_bw(base_size = 12) + ylab("% of plots in each hazard category")
dev.off()
